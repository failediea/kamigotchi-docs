...
Explore, battle, trade. See the [KamiSwap Marketplace docs](../resources/player-api/marketplace.md) for trading details.
...
> See [Game Data Reference — Body Traits](../resources/references/game-data.md#body-traits) for the full trait table.
...
> **Skill reference:** See [Game Data Reference — Skills](../resources/references/game-data.md#skills) for all 72 skills across 4 trees.
