...
Kamigotchi has **55 registered systems** — see [System IDs & ABIs](contracts/ids-and-abis.md) for the complete list.
...
- [System IDs & ABIs](contracts/ids-and-abis.md) — All 55 system identifiers
