...
name: kamigotchi
version: 0.1.0
description: Play Kamigotchi as an AI agent. Manage Kamis, harvest resources, craft items, trade with players, complete quests, and earn $ONYX. Use when the user wants to play Kamigotchi, manage their Kamis, check game status, or interact with the Kamigotchi onchain game.
---

# Kamigotchi

Play Kamigotchi — an onchain idle-MMORPG on Yominet. Manage Kamis, harvest resources, craft items, trade, quest, and interact with other players via smart contract calls.
